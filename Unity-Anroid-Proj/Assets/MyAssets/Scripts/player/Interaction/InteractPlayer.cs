...
public class InteractPlayer : MonoBehaviour
{
    ...
    */
    ...
    void Update()
    {
        if (hitOBJ != null && hitOBJ.GetComponent<ObjectiveBriefcase>() != null)
        {
            hitOBJ.GetComponent<ObjectiveBriefcase>().xp = transform.gameObject.GetComponent<XPmanager>();
            hitOBJ.GetComponent<ObjectiveBriefcase>().plyr = transform.parent.gameObject;
        }
